<html>
	...
	<style type="text/css">@import "cssfriar.css";</style>
	
	<script type="text/javascript" src="https://www.um.es/atica/documentos/forja/js/jqueryPlugins/tablesorter/doc/js/jquery.js"></script>
